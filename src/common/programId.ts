...
export const CREATE_CPMM_POOL_AUTH = new PublicKey("ArS2RdBKrpkBpZvka5tLFEw2SpXfi98VmF2EgjzgeG4P");
export const CREATE_CPMM_POOL_FEE_ACC = new PublicKey("ArS2RdBKrpkBpZvka5tLFEw2SpXfi98VmF2EgjzgeG4P");
